...
public:
    ...
    void setupUi(QWidget *InFlowWidget)
    {
        ...
        u_velocity_combo_box->setGeometry(QRect(10, 130, 60, 20));
        u_velocity_combo_box->setMinimum(-99);
        ...
        v_velocity_combo_box->setGeometry(QRect(10, 170, 60, 20));
        v_velocity_combo_box->setMinimum(-99);
        density_combo_box = new QDoubleSpinBox(InFlowWidget);
        density_combo_box->setObjectName(QStringLiteral("density_combo_box"));
        density_combo_box->setGeometry(QRect(10, 210, 60, 20));
        ...
        red_combo_box->setGeometry(QRect(10, 250, 60, 20));
        ...
        green_combo_box->setGeometry(QRect(10, 290, 60, 20));
        ...
        blue_combo_box->setGeometry(QRect(10, 330, 60, 20));
        blue_combo_box->setMaximum(255);
        label = new QLabel(InFlowWidget);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(100, 130, 61, 16));
        label_2 = new QLabel(InFlowWidget);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(100, 170, 55, 16));
        ...
        height_combo_box = new QDoubleSpinBox(InFlowWidget);
        height_combo_box->setObjectName(QStringLiteral("height_combo_box"));
        height_combo_box->setGeometry(QRect(10, 530, 60, 20));
        height_combo_box->setMaximum(1);
        height_combo_box->setSingleStep(0.01);
        label_8 = new QLabel(InFlowWidget);
        label_8->setObjectName(QStringLiteral("label_8"));
        label_8->setGeometry(QRect(100, 530, 55, 16));
        y_origin_combo_box = new QDoubleSpinBox(InFlowWidget);
        y_origin_combo_box->setObjectName(QStringLiteral("y_origin_combo_box"));
        y_origin_combo_box->setGeometry(QRect(10, 450, 60, 20));
        ...
        x_origin_combo_box->setGeometry(QRect(10, 410, 60, 20));
        x_origin_combo_box->setMaximum(1);
        x_origin_combo_box->setSingleStep(0.01);
        width_combo_box = new QDoubleSpinBox(InFlowWidget);
        width_combo_box->setObjectName(QStringLiteral("width_combo_box"));
        width_combo_box->setGeometry(QRect(10, 490, 60, 20));
        width_combo_box->setMaximum(1);
        width_combo_box->setSingleStep(0.01);
    ...
    void retranslateUi(QWidget *InFlowWidget)
    {
        ...
        label_7->setText(QApplication::translate("InFlowWidget", "Width", 0));
        label_8->setText(QApplication::translate("InFlowWidget", "Height", 0));
        ...
        label_12->setText(QApplication::translate("InFlowWidget", "Emitter Size", 0));
